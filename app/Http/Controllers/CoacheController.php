...
class CoacheController extends VoyagerBaseController
{
    ...
    public function show(Request $request, $id)
    {
        ...
        $field = array("name","field_of_training");
        for($x = 0;$x<count($dataType->readRows);$x++){
            
            if(!in_array($dataType->readRows[$x]['field'], $field)){
                unset($dataType->readRows[$x]);
            }
    ...
    public function dataType($dataType){
        ...
        if($dataType->controller == "\\App\\Http\\Controllers\\CoacheController"){
