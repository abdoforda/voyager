...
return [
    ...
    'required'             => 'مطلوب إدخال :attribute',
    ...
    'size'                 => [
        ...
        'string'  => 'يجب أن يحتوي  :attribute على :size حروف بالضبط',
    ],
    ...
    'attributes'           => [
        ...
        'company_profile'                  => 'الملف التعريفى للشركة',
        'field_of_training'     => 'المجال التدريبي',
        ...
        'zone'     => 'المنطقة',
        'zip'     => 'الكود',
        'type'     => 'الدراسة المطلوبة',
        'entity'     => 'الجهة المقدم لها الدراسة',
        'card_number'     => 'رقم الكارت',
        'exp_year'     => 'سنة الإنتهاء',
        'exp_month'     => 'شهر الإنتهاء',
        'security'     => 'الرقم السري',
        'project'     => 'نبذة مختصرة عن المشروع',
    ],
];